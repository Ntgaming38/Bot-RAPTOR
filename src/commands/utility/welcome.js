...
module.exports = {
  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand(s => s
      ...
      .addChannelOption(o => o.setName('channel').setDescription('Kênh gửi welcome (#welcome)').addChannelTypes(ChannelType.GuildText, ChannelType.GuildAnnouncement).setRequired(true))
      .addStringOption(o => o.setName('title').setDescription('Tiêu đề, VD: By RAPTOR'))
      .addChannelOption(o => o.setName('role-channel').setDescription('Kênh chọn role ✅').addChannelTypes(ChannelType.GuildText, ChannelType.GuildAnnouncement))
      .addChannelOption(o => o.setName('rules-channel').setDescription('Kênh luật').addChannelTypes(ChannelType.GuildText, ChannelType.GuildAnnouncement))
      .addChannelOption(o => o.setName('announce-channel').setDescription('Kênh thông báo 🔊').addChannelTypes(ChannelType.GuildText, ChannelType.GuildAnnouncement))
      .addChannelOption(o => o.setName('chat-channel').setDescription('Kênh chat chung 💬').addChannelTypes(ChannelType.GuildText, ChannelType.GuildAnnouncement))
